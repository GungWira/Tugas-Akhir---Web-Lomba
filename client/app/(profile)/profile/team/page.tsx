...
export default function Team() {
    ...
    return(
        <div className="w-full relative bg-blueFade min-h-screen">
            <NavbarBackTitled href="/profile" className="pb-6">Team</NavbarBackTitled>
            <div className="flex pt-24 min-h-screen">
                <div className="bg-[#F1F2F6] w-full min-h-full rounded-3xl p-6 flex flex-col gap-3" style={{borderBottomLeftRadius:"0", borderBottomRightRadius:"0"}}>
                    {/* CARD */}
                    <div className="w-full rounded-xl bg-white flex flex-col gap-4 p-4 py-6" onClick={() => {handleDetail("id")}}>
                        <div className="flex flex-row justify-between items-center">
                            <div className="w-full">
                                {user && user.imageUrl ? 
                                    <p className="font-poppinsSemiBold text-normalText text-base">Tim maba</p>
                        ...
                        <div className="flex flex-col justify-start items-start gap-1 w-full">
                            <div className="w-full bg-white border px-3 py-1 rounded-md flex flex-row justify-between gap-2 items-center">
                                <div className="min-w-10 max-w-10 w-10 aspect-square rounded-full border overflow-hidden">
                                    <Image
                                        src={user && user.imageUrl ? user.imageUrl : '/imgs/dashboard-imgs/Default-Profile-Img.svg'}
